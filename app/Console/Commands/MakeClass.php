...
class MakeClass extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:class {name : Name of the class}';
     ...
     * @var string
     */
    protected $description = 'Create a PHP class';
    ...
    public function handle()
    {
        ...
        if(file_exists($stub)){
            ...
            $this->error('Class stub does not exist.');
        }
        return 0;
    }
}
